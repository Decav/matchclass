...
* 🟢 **Verde Intenso (90% - 100%):** Asistencia casi perfecta[cite: 3]. Bloque altamente recomendado[cite: 3].
* 🟢 **Verde Claro (70% - 89%):** Asistencia alta[cite: 3]. Opción viable[cite: 3].
* 🟡 **Amarillo (50% - 69%):** Disponibilidad media[cite: 3]. Usar solo como alternativa secundaria[cite: 3].
* 🔴 **Rojo (< 50%):** Conflicto mayoritario de horarios[cite: 3].
...
> * **1° Lugar:** Martes, Bloque 9-10 (14:30 - 15:40) — 38/40 Alumnos disponibles (95%)[cite: 3]
> * **2° Lugar:** Jueves, Bloque 11-12 (15:55 - 17:05) — 35/40 Alumnos disponibles (88%)[cite: 3]
